...
# vpnkit requires non-glibc system for static build (https://github.com/moby/vpnkit/issues/407)
FROM alpine:3.7 AS vpnkit
RUN apk --no-cache add bash build-base patch git ocaml opam
