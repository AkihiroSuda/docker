...
func TestChunkStringsRandom_1_4(t *testing.T) {
	testChunkStringsRandom(t, 1, 4, time.Now().UnixNano())
}
...
func TestChunkStringsRandom_1000_9(t *testing.T) {
	testChunkStringsRandom(t, 1000, 9, time.Now().UnixNano())
}
