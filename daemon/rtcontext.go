...
func introspectRuntimeTaskContext(c *container.Container,
	cluster IntrospectableCluster) *runtimeTaskContext {
...
func introspectRuntimeServiceContext(c *container.Container,
	cluster IntrospectableCluster) *runtimeServiceContext {
